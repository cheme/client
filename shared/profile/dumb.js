...
import {normal, checking, revoked, error, metaNone, metaNew, metaRevoked, metaUnreachable} from '../constants/tracker'
...
export const proofsRevoked = proofsDefault.map((proof, idx) => ({...proof, state: idx % 2 ? checking : revoked, meta: idx % 2 ? metaNone : metaRevoked}))
